...
form.addEventListener('submit',(event) => {
    ...
    let campuri_obligatorii = [user.username,user.password,user.password_confirmation,user.email]; // array cu campurile obligatorii
    ...
    if(user.password.value != user.password_confirmation.value) {  // Verific daca parola si confirmare parola au aceiasi valoare
    ...
    const verifica_parola = regex.test(user.password.value) // testez daca parola introdusa respecta cerintele de mai sus
